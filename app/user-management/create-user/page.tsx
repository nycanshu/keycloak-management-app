      ...
      {userResponse ? (
        ...
        <div className="bg-card p-8 rounded-2xl shadow-md w-full max-w-sm space-y-6">
          {isExists === null || isExists === true ? (
            <>
              <h1 className="text-2xl font-semibold text-center text-foreground">Enter email to continue</h1>
              <form onSubmit={handleCheckUser} className="space-y-4">
                ...
                >
                  {loading ? "Checking..." : isExists === true ? "User Exists" : "Continue"}
                </button>
              </form>
            </>
          ) : (
            <>
              <h1 className="text-2xl font-semibold text-center text-foreground">Add a New User</h1>
